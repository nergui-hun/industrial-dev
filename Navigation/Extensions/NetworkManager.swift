...
struct NetworkManager {
    ...
    static private(set) var title = "TEST"
    static private(set) var orbitalPeriod = "TEST"
    static private(set) var planetName = "TEST"
    ...
    static func getPlanetData() {
        ...
        session.dataTask(with: url) { data, response, error in
            ...
            let decoder = JSONDecoder()
                ...
                NetworkManager.orbitalPeriod = decodedData.orbitalPeriod
            } catch {
                print(error.localizedDescription)
            }
        }.resume()
